...
def training_dataset(file_path, n_states, n_repeat_states, subjects):
    """
    ...
    """
    n_wake, n_n1, n_n2, n_n3, n_rem = n_states
    n_repeat_wake, n_repeat_n1, n_repeat_n2, n_repeat_n3, n_repeat_rem = n_repeat_states
    training_dataset = np.empty((0, 13))
