...
class StatesAnalysis(object):   
    ...
    def analyzeStates(self):
        ...
        all_latent_states = np.empty((len(self.uniqueStates[:, 0]), 16))
    ...
    def MI_stimulusH_barPlot(self, MI_stage, stagesH, overAll, saveDir):
        ...
        ax1.bar(ind+2*width, MI_stage[2]/stagesH[2], bar_width, color=colors[7]['color'], edgecolor = "none", label="N2")
        ax1.bar(ind+3*width, MI_stage[3]/stagesH[3], bar_width, color=colors[6]['color'], edgecolor = "none", label="N3")
    ...
    def plotHistogram(self, saveDir, name, yLim):       
        ...
        n1_patch = mpatches.Patch(color=(0.5, 0.5, 0.0), label='N1')
        n2_patch = mpatches.Patch(color=(0.0, 0.5, 0.5), label='N2')
        n3_patch = mpatches.Patch(color=(0.2, 0.3, 0.5), label='N3')
